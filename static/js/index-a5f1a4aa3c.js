...
Ctrl = angular.module('app',['ngSanitize','ngTouch']).controller('Ctrl',['$sce','$scope',function($sce,$scope){
    ...
    $scope.data = [{
        "username" : "林紫薇",
        "feedimage" : '/moment/static/image/linziwei-pic-e43a0535b7.jpg',
        "avatar" : '/moment/static/image/linziwei-99dacc4ec9.jpg',
        "feed" : '一晚吃七盒,好幸福~'+get_emoj('emoj-haixiu-301f2dfe8f.png')+get_emoj('emoj-haixiu-301f2dfe8f.png'),
        "time": '20分钟前',
        "zans" : ['老干部华华'],
        "cais"　:　['佛爷霆,','有朋自远方来'],
        "comment" : [{
            'username' : '老干部华华:',
            'message' : '多吃点,爱你 ' + get_emoj('emoj-qinqin-8d13bd974d.png')
        },{
            'username' : '范爷:',
            'message' : '这碗狗粮我干了!看来得让黑牛好好学着点!' + get_emoj('emoj-zuohengheng-77a2c20188.png') + get_emoj('emoj-zuohengheng-77a2c20188.png')
        },{
            'username' : '有朋自远方来:',
            'message' : '深夜放毒,一人吃,两人补' + get_emoj('emoj-zaijian-a9a3736a84.png')
        }]
    },{
        "username" : "小笼包女",
        "feedimage" : "/moment/static/image/xiaolongbaonv-pic-640676bddc.jpg",
        "avatar" : "/moment/static/image/xiaolongbaonv-6cf021dd40.jpg",
        "feed" : "某人给买的夜宵,我是该哭还是该笑啊"+get_emoj('emoj-se-bfca6fc2de.png')+" 不过真的好好吃诶!",
        "time" : '20分钟前',
        "zans" : ['陈过儿'],
        "cais"　:　['贾大玲'],
        "comment" : [{
        ...
        "username" : "小赵总",
        "feedimage" : '/moment/static/image/xiaozhaozong-pic-d809e14ca0.jpg',
        "avatar" : '/moment/static/image/xiaozhaozong-06d5ad98fa.jpg',
        "feed" : '大晚上的,我真的要吃成' +get_emoj('emoj-zhu-4d3fe42dd9.png')+'啦~撑死算工伤吗哈哈哈~',
        'time' : '20分钟前',
        "zans" : ['塘主翰'],
        "cais"　:　['佛爷霆'],
        "comment" : [{
        ...
        "username" : '绵羊兴',
        'feedimage' : '/moment/static/image/mianyangxing-pic-eec6f545ca.jpg',
        'avatar' : '/moment/static/image/mianyangxing-0565765fe7.jpg',
        ...
        'comment' : [{
            'username' : '抠门迅:',
            'message' : '哎呀你怎么这么抠啊, 就自己吃不给我来点' + get_emoj('emoj-weiqu-f4a618dd25.png')

        },{
            'username' : '朱碧石:',
            'message' : '你不要脸（请自行想象我的表情包谢谢'+get_emoj('emoj-weixiao-107ee3f515.png')+'）'
        },{
            'username'　:　'神算磊:',
        ...
        'username'　:　'小岳岳',
        'feedimage'　:　'/moment/static/image/xiaoyueyue-pic-de6ba161a7.jpg',
        'avatar'　:　'/moment/static/image/xiaoyueyue-3367f31732.jpg',
        'feed'　:　'啊~五碗,你比空碗多五碗!我的天呐今天晚上好撑!' + get_emoj('emoj-haixiu-301f2dfe8f.png'),
        'time' : '20分钟前',
        "zans" : ['liu留,','海海,','绵绵,','酸菜'],
        "cais"　:　['郭奶奶'],
        'comment' : [{
            'username' : '郭奶奶:',
            'message' : '瞧你那没出息样儿,五碗就撑死了,为师还比你多三碗' + get_emoj('emoj-haixiu-301f2dfe8f.png')
        }]
    },{
        'username' : '逗比亮亮',
        'feedimage'　:　'/moment/static/image/doubiliangliang-pic-fa94547d85.jpg',
        'avatar'　:　'/moment/static/image/doubiliangliang-f7470443f2.jpg',
        'feed'　:　'晚上也停不住嘴啊,真的有那么好吃吗'　+ get_emoj('emoj-yanxia-2092a3a537.jpg'),
        'time' : '20分钟前',
        "zans" : ['馨爷'],
        "cais"　:　['美小璐'],
        'comment' : [{
            ...
            'username'　:　'美小璐:',
            'message'　:　'发图也不把闺女P白点,你是亲爹嘛' + get_emoj('emoj-koubi-dd4a2e451b.jpg')
        }]

    },{
        'username' : '涛哥',
        'feedimage'　:　'/moment/static/image/taoge-pic-d3a6752a8f.jpg',
        'avatar'　:　'/moment/static/image/taoge-c06a273139.jpg',
        'feed'　:　'深夜来波福利,不用谢!',
        'time' : '20分钟前',
        "zans" : ['马社长,','杜海,','亮亮,','小岳岳'],
        "cais"　:　['昕昕,','嘉嘉'],
        'comment' : [{
            'username' : '何老师:',
            'message'　:　'涛啊,最近又胖了'　+get_emoj('emoj-yinxian-67c331ccf9.jpg')
        },{
            'username'　:　'娜娜:',
        ...
        'username' : '马睿马同学',
        'feedimage'　:　'/moment/static/image/marui-pic-3b7a76fcd5.jpg',
        'avatar'　:　'/moment/static/image/marui-cf99fe1195.jpg',
        'feed'　:　'二毛,你看朕的吃相帅不帅啊?',
        'time' : '20分钟前',
        "zans" : ['二毛,','二老婆,','三老婆,','小老婆'],
        "cais"　:　['三毛,','四毛,','大老婆'],
        'comment' : [{
            ...
            'username'　:　'四毛:',
            'message'　:　get_emoj('emoj-weixiao-107ee3f515.png')
        }]
...
},{"../../bower_components/angular-sanitize/angular-sanitize.min.js":1,"../../bower_components/angular-touch/angular-touch.min.js":2,"../../bower_components/angular/angular.min.js":3,"../../bower_components/swiper/dist/js/swiper.min.js":4,"../../bower_components/velocity/velocity.min.js":5,"../../bower_components/zepto/zepto.js":6,"../../bower_components/zeptojs/src/touch.js":7,"../js/share.min.js":9}],9:[function(require,module,exports){
!function e(n,t,i){function r(c,s){if(!t[c]){if(!n[c]){var u="function"==typeof require&&require;if(!s&&u)return u(c,!0);if(o)return o(c,!0);throw new Error("Cannot find module '"+c+"'")}var a=t[c]={exports:{}};n[c][0].call(a.exports,function(e){var t=n[c][1][e];return r(t?t:e)},a,a.exports,e,n,t,i)}return t[c].exports}for(var o="function"==typeof require&&require,c=0;c<i.length;c++)r(i[c]);return r}({1:[function(){$(function(){function e(e){wx.onMenuShareAppMessage({title:e.title,desc:e.desc,link:e.link,imgUrl:e.logo,success:function(){}}),wx.onMenuShareTimeline({title:e.title+","+e.desc,desc:e.title,link:e.link,imgUrl:e.logo,success:function(){}})}var n={link:"http://h5.imxiaowei.com/moment/",imgUrl:"http://vs.importos.com/static/image/share-image.png",title:"蔚然大观，揽尽情怀",desc:"蔚然大观，揽尽情怀"};$.get("http://jianfei.7cha.com/data/index.php","",function(t){wx.config({appId:t.appId,timestamp:t.timestamp,nonceStr:t.nonceStr,signature:t.signature,jsApiList:["checkJsApi","onMenuShareTimeline","onMenuShareAppMessage"]}),wx.ready(function(){e(n)}),wx.error(function(){})},"jsonp")})},{}]},{},[1]);
},{}]},{},[8])